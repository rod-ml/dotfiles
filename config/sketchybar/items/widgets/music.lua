...
-- Same spacing as the right-side widget bubbles
sbar.add("item", { position = "left", width = settings.group_paddings })

-- Left-side items render left-to-right in creation order:
-- cover (leftmost), then text, then play/pause toggle.
